...
import eu.siacs.auva.crypto.XmppDomainVerifier;
import eu.siacs.auva.crypto.axolotl.AxolotlService;
import eu.siacs.auva.crypto.sasl.Anonymous;
import eu.siacs.auva.crypto.sasl.DigestMd5;
import eu.siacs.auva.crypto.sasl.External;
import eu.siacs.auva.crypto.sasl.Plain;
import eu.siacs.auva.crypto.sasl.SaslMechanism;
import eu.siacs.auva.crypto.sasl.ScramSha1;
import eu.siacs.auva.crypto.sasl.ScramSha256;
import eu.siacs.auva.crypto.sasl.ScramSha512;
...
import eu.siacs.auva.services.MemorizingTrustManager;
import eu.siacs.auva.services.MessageArchiveService;
import eu.siacs.auva.services.NotificationService;
...
import eu.siacs.auva.utils.SSLSocketHelper;
import eu.siacs.auva.utils.SocksSocketFactory;
import eu.siacs.auva.utils.XmlHelper;
import eu.siacs.auva.xml.Element;
import eu.siacs.auva.xml.LocalizedContent;
import eu.siacs.auva.xml.Namespace;
import eu.siacs.auva.xml.Tag;
import eu.siacs.auva.xml.TagWriter;
import eu.siacs.auva.xml.XmlReader;
import eu.siacs.auva.xmpp.forms.Data;
import eu.siacs.auva.xmpp.jingle.OnJinglePacketReceived;
import eu.siacs.auva.xmpp.jingle.stanzas.JinglePacket;
import eu.siacs.auva.xmpp.stanzas.AbstractAcknowledgeableStanza;
...
import eu.siacs.auva.xmpp.stanzas.csi.ActivePacket;
import eu.siacs.auva.xmpp.stanzas.csi.InactivePacket;
import eu.siacs.auva.xmpp.stanzas.streammgmt.AckPacket;
import eu.siacs.auva.xmpp.stanzas.streammgmt.EnablePacket;
import eu.siacs.auva.xmpp.stanzas.streammgmt.RequestPacket;
import eu.siacs.auva.xmpp.stanzas.streammgmt.ResumePacket;
