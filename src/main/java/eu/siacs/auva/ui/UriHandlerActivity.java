...
import eu.siacs.auva.databinding.ActivityUriHandlerBinding;
...
import eu.siacs.auva.utils.ProvisioningUtils;
...
public class UriHandlerActivity extends AppCompatActivity {
    ...
    private static Class<?> findShareViaAccountClass() {
        try {
            return Class.forName("eu.siacs.auva.ui.ShareViaAccountActivity");
