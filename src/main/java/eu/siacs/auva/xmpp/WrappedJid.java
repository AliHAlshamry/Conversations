...
public class WrappedJid implements eu.siacs.auva.xmpp.Jid {
    ...
    @Override
    public eu.siacs.auva.xmpp.Jid asBareJid() {
        return new WrappedJid(inner.asBareJid());
    }

    @Override
    public eu.siacs.auva.xmpp.Jid withResource(CharSequence resource) {
    ...
    @Override
    public eu.siacs.auva.xmpp.Jid getDomain() {
    ...
    @Override
    public int compareTo(eu.siacs.auva.xmpp.Jid jid) {
