...
import eu.siacs.chatx.entities.Message.FileParams;
import eu.siacs.chatx.entities.RtpSessionStatus;
...
import eu.siacs.chatx.ui.ConversationFragment;
import eu.siacs.chatx.ui.ConversationsActivity;
import eu.siacs.chatx.ui.XmppActivity;
import eu.siacs.chatx.ui.service.AudioPlayer;
import eu.siacs.chatx.ui.text.DividerSpan;
import eu.siacs.chatx.ui.text.QuoteSpan;
import eu.siacs.chatx.ui.util.AvatarWorkerTask;
import eu.siacs.chatx.ui.util.MyLinkify;
import eu.siacs.chatx.ui.util.QuoteHelper;
import eu.siacs.chatx.ui.util.ViewUtil;
import eu.siacs.chatx.ui.widget.ClickableMovementMethod;
import eu.siacs.chatx.utils.CryptoHelper;
import eu.siacs.chatx.utils.EmojiWrapper;
import eu.siacs.chatx.utils.Emoticons;
...
//                viewHolder.edit_indicator.setAlpha(darkBackground ? 0.7f : 0.57f);
                viewHolder.edit_indicator.setImageResource(R.drawable.ic_edit_2_gray);
            } else {
