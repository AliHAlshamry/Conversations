...
public final class Config {
    ...
    public static final Jid BUG_REPORTS = Jid.of("bugs@auva-app.com");
    public static final Uri HELP = Uri.parse("https://help.auva-app.com");


    public static final String DOMAIN_LOCK = "auva-app.com"; //only allow account creation for this domain
    public static final String MAGIC_CREATE_DOMAIN = "auva-app.com";
    public static final Jid QUICKSY_DOMAIN = Jid.of("auva-app.com");
