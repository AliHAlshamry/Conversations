...
import eu.siacs.auva.services.ExportBackupService;
        ...
        if (d != null) {
            switch (d.getStatus()) {
                case Transferable.STATUS_CHECKING:
                    return new Pair<>(getFileDescriptionString(context, message) + "/" + -1, true);
                case Transferable.STATUS_DOWNLOADING:
                    return new Pair<>(getFileDescriptionString(context, message) + "/" + d.getProgress(), true);
