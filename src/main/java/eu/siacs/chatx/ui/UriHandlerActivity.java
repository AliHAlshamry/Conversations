...
import eu.siacs.chatx.databinding.ActivityUriHandlerBinding;
...
import eu.siacs.chatx.utils.ProvisioningUtils;
...
public class UriHandlerActivity extends AppCompatActivity {
    ...
    private static Class<?> findShareViaAccountClass() {
        try {
            return Class.forName("eu.siacs.chatx.ui.ShareViaAccountActivity");
