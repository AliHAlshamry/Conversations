...
public class WrappedJid implements eu.siacs.chatx.xmpp.Jid {
    ...
    @Override
    public eu.siacs.chatx.xmpp.Jid asBareJid() {
        return new WrappedJid(inner.asBareJid());
    }

    @Override
    public eu.siacs.chatx.xmpp.Jid withResource(CharSequence resource) {
    ...
    @Override
    public eu.siacs.chatx.xmpp.Jid getDomain() {
    ...
    @Override
    public int compareTo(eu.siacs.chatx.xmpp.Jid jid) {
